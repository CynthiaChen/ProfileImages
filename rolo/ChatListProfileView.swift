...
class ChatListProfileView: UIView {
    ...
    private func setupImages(users: [ChatUser]) {
        ...
        if count == 1 {
            ...
            img.sd_setImage(with: URL(string: users[0].profileImage ?? ""), placeholderImage: imageWith(name: users[0].name ?? ""), completed: nil)
            addSubview(img)
            ...
            img2.sd_setImage(with: URL(string: users[1].profileImage ?? ""), placeholderImage: imageWith(name: users[1].name ?? ""), completed: nil)
            addSubview(img2)
            ...
            img3.sd_setImage(with: URL(string: users[2].profileImage ?? ""), placeholderImage: imageWith(name: users[2].name ?? ""), completed: nil)
            addSubview(img3)
            ...
            img4.sd_setImage(with: URL(string: users[3].profileImage ?? ""), placeholderImage: imageWith(name: users[3].name ?? ""), completed: nil)
            addSubview(img4)
